...
--
-- Name: website_insash; Type: DATABASE; Schema: -; Owner: jeandidier
--

CREATE DATABASE website_insash WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE website_insash OWNER TO jeandidier;

\connect website_insash
...
5230f095-265d-4745-b013-0688eb87adcc	e5f9df1d-123a-471c-9b18-45ab6ac8a1c7
